...
export function getSystemTitle() {
  ...
  if (!system_title) return '';
  return system_title;
}

export function getSystemDescription() {
  let system_description = localStorage.getItem('system_description');
  if (!system_description) return '';
  return system_description;
}

export function getSystemKeywords() {
  let system_keywords = localStorage.getItem('system_keywords');
  if (!system_keywords) return '';
